...
const productsDiv = document.querySelector("div");
...
function showCategory(category) {
    for (let i = products[category].length - 1; i >= 0; i--) {
        productsDiv.insertAdjacentHTML("afterbegin", getProductMarkup(products[category][i]));
    }
}
